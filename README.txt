...
2-Put it in the same folder as the .exe and name it "outline.png" *IT HAS TO BE PNG*
3-Make the texture with no outlines(aka texture number 26)
4-Put it in the same folder as the .exe and name it "texture.png" *IT HAS TO BE PNG*
5-Run the EXE
